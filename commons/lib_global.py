...
def account_select(context, acc_no):
    condition_1 = "savings account"
    condition_2 = "current and inavalid currency"
    condition_3 = "special account"
    if condition_1:
        lib_global.click_element(context, "xpath", f"//label[text()='Saving_Individ...{acc_no}']")
    elif condition_2:
        lib_global.click_element(context, "xpath", f"//label[text()='Current Accoun...{acc_no}']")
    elif condition_3:
        lib_global.click_element(context, "xpath", f"//label[text()='CASH ACCOUNT -...{acc_no}']")
    else:
        raise ValueError("Unsupported condition or account type")
